              ...
              <div class="card-body">
                <form method="POST" action="{{ route('user.update', $user->id) }}">
                    ...
                    <div class="form-group mb-3 ">
                        ...
                        <div>
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama"  value="{{ $user->name }}">
                            @error('nama')
                    ...
                    <div class="form-group mb-3 ">
                        ...
                        <div>
                            <input type="text" class="form-control @error('username') is-invalid @enderror" name="username" {{ $user->username }}>
                            @error('username')
                            <div class="invalid-feedback" role="alert">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group mb-3 ">
                        ...
                        <div>
                            <input type="text" class="form-control @error('no_telp') is-invalid @enderror" name="no_telp"  value="{{ $user->phone }}" onkeyup="validNumber(this)">
                            @error('no_telp')
                            <div class="invalid-feedback" role="alert">
                                {{ $message }}
                            </div>
